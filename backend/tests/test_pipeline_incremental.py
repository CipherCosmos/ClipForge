...
from app.models import JobStatusEnum, JobTypeEnum, Video, VideoStatusEnum
...
async def test_start_pipeline_fresh_video():
    ...
    with (
        patch("app.workers.transcription.run_transcription.delay") as mock_transcribe_delay,
